...
def run(data, reports_):
    ...
    data=machine.get_data(data,[
        ...
        'perm: ACCESS_COARSE_LOCATION','perm: RECEIVE_SMS','perm: WRITE_SMS','perm: SEND_SMS','perm: UNINSTALL_SHORTCUT','perm: INSTALL_SHORTCUT','perm: SET_PREFERRED_APPLICATIONS','perm: ACCESS_NETWORK_STATE','perm: READ_CONTACTS','perm: WAKE_LOCK','perm: READ_EXTERNAL_STORAGE','call__'])
